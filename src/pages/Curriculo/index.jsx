...
const experiences = [
    ...
    {
        company: 'IBICT',
        role: 'Bolsa de Pesquisa - Desenvolvimento Web',
        period: '2026 - Atual',
        location: 'Brasília / Remoto',
        logo: ibictLogo,
        badges: ['WordPress', 'PHP', 'APIs REST', 'JavaScript', 'Acervos digitais', 'Tainacan'],
        description: [
            '- Desenvolvimento de soluções para o ecossistema ODIS, voltadas à gestão e difusão do patrimônio cultural brasileiro.',
            '- Desenvolvimento de plugins personalizados para WordPress e Tainacan.',
            '- Integração com APIs REST e sistemas externos.',
            '- Desenvolvimento de componentes reutilizáveis para instituições públicas.',
            '- Criação de funcionalidades para gestão de acervos digitais.',
            '- Otimização de desempenho e arquitetura de aplicações WordPress.',
        ],
    },
    {
